...
public class VIC656X extends PeripheralDevice {
	...
	VIC656X(String identity, C64System memory) {
	...
	void reset(float clock) {
		...
		screenBuffer = new Color[rasterLinePixels][rasterLines];
	}
	...
	void write(int address, int data) {
		...
		case 0x11:
			...
			ECM  	= (data&0b01000000)!=0;
			BMM  	= (data&0b00100000)!=0;
			DEN  	= (data&0b00010000)!=0;
			RSEL 	= (data&0b00001000)!=0;
			YSCROLL = (data&0b00000111);
			break;
		case 0x12:
		...
		case 0x14:
			...
			break;
		case 0x15:
			M0E 	= (data&0b00000001)!=0;
			M1E 	= (data&0b00000010)!=0;
			M2E 	= (data&0b00000100)!=0;
			M3E 	= (data&0b00001000)!=0;
			M4E 	= (data&0b00010000)!=0;
			M5E 	= (data&0b00100000)!=0;
			M6E 	= (data&0b01000000)!=0;
			M7E 	= (data&0b10000000)!=0;
			break;
		case 0x16:
			RES 	= (data&0b00100000)!=0;
			MCM 	= (data&0b00010000)!=0;
			CSEL	= (data&0b00001000)!=0;
			XSCROLL = (data&0b00000111);
			break;
		case 0x17:
		...
		case 0x18:
			...
			break;
		case 0x19:
			IRQ 	= (data&0b10000000)!=0;
			ILP		= (data&0b00001000)!=0;
			IMMC	= (data&0b00000100)!=0;
			IMBC	= (data&0b00000010)!=0;
			IRST	= (data&0b00000001)!=0;
			break;
		case 0x1A:
			ELP		= (data&0b00001000)!=0;
			EMMC	= (data&0b00000100)!=0;
			EMBC	= (data&0b00000010)!=0;
			ERST	= (data&0b00000001)!=0;
			break;
		case 0x1B:
			M0DP 	= (data&0b00000001)!=0;
			M1DP 	= (data&0b00000010)!=0;
			M2DP 	= (data&0b00000100)!=0;
			M3DP 	= (data&0b00001000)!=0;
			M4DP 	= (data&0b00010000)!=0;
			M5DP 	= (data&0b00100000)!=0;
			M6DP 	= (data&0b01000000)!=0;
			M7DP 	= (data&0b10000000)!=0;
			break;
		case 0x1C:
			M0MC 	= (data&0b00000001)!=0;
			M1MC 	= (data&0b00000010)!=0;
			M2MC 	= (data&0b00000100)!=0;
			M3MC 	= (data&0b00001000)!=0;
			M4MC 	= (data&0b00010000)!=0;
			M5MC 	= (data&0b00100000)!=0;
			M6MC 	= (data&0b01000000)!=0;
			M7MC 	= (data&0b10000000)!=0;
			break;
		case 0x1D:
			/*M0Y 	= (M0X&0xFF)|((data<<1)&0x100);
			M1Y 	= (M1X&0xFF)|((data<<1)&0x100);
