...
public class C64System extends MemAccess {
	static final int ID_VICII_NTSC = 1;//"VICII_NTSC";
	static final int ID_VICII_PAL = 2;//"VICII_PAL";
	static final int ID_SID = 3;//"SID";
	static final int ID_CIA1 = 4;//"CIA1";
	static final int ID_CIA2 = 5;//"CIA2";
	static final int ID_UNK = -1;//"UNKNOWN";
	
	static final int DDR_6510 = 0x0000;
	static final int PORT_6510 = 0x0001;
	...
	void initialize(float clock) throws IOException {
